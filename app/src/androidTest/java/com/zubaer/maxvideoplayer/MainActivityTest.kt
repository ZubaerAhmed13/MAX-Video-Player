...
class MainActivityTest {
    ...
    fun releaseLibraryChromeRendersWithoutPermanentSearchOrLegacyTopStrip() {
        ...
        rule.onNodeWithTag("library_search_icon", useUnmergedTree = true).assertExists()
        rule.onNodeWithTag("library_view_button").assertIsDisplayed()
        rule.onNodeWithTag("library_view_icon", useUnmergedTree = true).assertExists()
        rule.onNodeWithTag("library_more_button").assertIsDisplayed()
        rule.onNodeWithTag("library_more_icon", useUnmergedTree = true).assertExists()
    ...
    fun searchIsProgressivelyDisclosedAndBackRestoresCompactAppBar() {
        ...
        rule.onNodeWithTag("clear_search_icon", useUnmergedTree = true).assertExists()
